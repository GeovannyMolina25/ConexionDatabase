...
public class profesor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblProfesor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Cedula", "Nombre", "sexo", "fecha_Nac", "Titulo", "Direccion", "Telefono", "Email", "Observaciones"
            }
        ));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO profesor(codigo_pro,cedula_pro,nombre_pro,sexo_pro,fecha_nac_pro,titulo_pro,direccion_pro,telefono_pro,email_pro,observaciones_pro) VALUES(?,?,?,?,?,?,?,?,?,?)");
    ...
    private void tblProfesorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProfesorMouseClicked
        ...
        try{
            ...
            Connection con = Conexion.getConexion();
             ...
             ResultSet rs;
             ps = con.prepareStatement("SELECT cedula_pro,nombre_pro,sexo_pro,fecha_nac_pro,titulo_pro, direccion_pro,telefono_pro,email_pro,observaciones_pro FROM profesor WHERE codigo_pro=?");
             ps.setString(1, id);
             rs=ps.executeQuery();
             
             while(rs.next()){
                 txtCodigo.setText(String.valueOf(id));
                 txtCedula.setText(rs.getString("cedula_pro"));
                 txtNombre.setText(rs.getString("nombre_pro"));
                 txtFechaNac.setText(rs.getString("fecha_nac_pro"));
                 txtTitulo.setText(rs.getString("titulo_pro"));
                 txtDireccion.setText(rs.getString("direccion_pro"));
                 txtTelefono.setText(rs.getString("telefono_pro"));
                 txtEmail.setText(rs.getString("email_pro"));
                 txtaObservaciones.setText(rs.getString("observaciones_pro"));
                 if(rs.getString("sexo_pro").equals("MASCULINO")){
                     rbMasculino.setSelected(true);
                 }else if(rs.getString("sexo_pro").equals("FEMENINO")){
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("UPDATE profesor SET cedula_pro=?,nombre_pro=?,sexo_pro=?,fecha_nac_pro=?,titulo_pro=?, direccion_pro=?,telefono_pro=?,email_pro=?,observaciones_pro=? WHERE codigo_pro=?" );
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try{
            Connection con = Conexion.getConexion();
            PreparedStatement ps = con.prepareStatement("DELETE FROM profesor WHERE codigo_pro=?" );
            ps.setString(1,codigo);
    ...
    private void cargarTabla(){
        ...
        try{
            Connection con = Conexion.getConexion();
             ...
             ps = con.prepareStatement("SELECT codigo_pro,cedula_pro,nombre_pro,sexo_pro,fecha_nac_pro,titulo_pro,direccion_pro,telefono_pro,email_pro,observaciones_pro FROM profesor");
             rs=ps.executeQuery();
             rsmd = rs.getMetaData();
